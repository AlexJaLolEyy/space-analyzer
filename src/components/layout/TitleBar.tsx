            ...
            >
                ...
                <div className="flex h-full items-center">
                    ...
                    <button
                        ...
                        title="Settings (⌘,)"
                        className={`flex items-center justify-center w-10 h-full hover:bg-muted transition-colors ${showSettings ? "text-primary" : "text-muted-foreground hover:text-foreground"}`}
                    >
